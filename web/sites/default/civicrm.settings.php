...
$civicrm_paths['civicrm.files']['url'] = 'https://bfc-crm.ddev.site//sites/default/files/civicrm';
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'https://bfc-crm.ddev.site');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'VOuw6EWZAnFtrncgT8HAXvlKDrLguwwfg9poPIW16gU');
}
...
if (!defined('CIVICRM_CRED_KEYS') ) {
  define( '_CIVICRM_CRED_KEYS', 'aes-cbc:hkdf-sha256:KQYB5yZepgBTwIE10Cfdru6K6CgSxs0V7DbZ4k1PLnUDFCAt6A');
...
if (!defined('CIVICRM_SIGN_KEYS') ) {
  define( '_CIVICRM_SIGN_KEYS', 'jwt-hs256:hkdf-sha256:GWwZFUs9lt8IYqCec5fKmoQaALjsoARDLL908fHm442gApkp8AwjwQ');
